...
##SBATCH --error=/nlsasfs/home/ttbhashini/sbishal/mangalik/MESGD_BTP/btp/gpt2_%x.%J.err
#SBATCH --output=/nlsasfs/home/ttbhashini/sbishal/mangalik/MESGD_BTP/btp/gpt2_%x.%J.out
