...
class NQ(Dataset):
    def __init__(self, path=f"{hydra.utils.get_original_cwd()}/data/nq/train.json"):
...
class zsRE(Dataset):
    def __init__(self, path=f"{hydra.utils.get_original_cwd()}/data/zsre/structured_zeroshot-train-new_annotated_final.jsonl", split="edit"):
